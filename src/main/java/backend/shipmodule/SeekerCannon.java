...
public class SeekerCannon extends OffensiveModule {
    ...
    /**
     * The target selector draws a selector around the targets
     * to indicate the search pattern of the seeker. This is done 
     * in a pattern going through the n-th closest enemies starting at 
     * the one farthest away and moving towards the nearest enemy.
     */
